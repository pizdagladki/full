...
## Responsibility
- Player and match reports: resource endpoints and migrations are added by downstream slices (the scaffold
  only wires the infra and a liveness probe).
...
- No MinIO or Telegram wiring at this stage — those are added when a resource slice requires them.
