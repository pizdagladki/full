...
## Responsibility
- ELO calculation, player levels, and match history: resource endpoints and migrations are added by
  downstream slices (the scaffold only wires the infra and a liveness probe).
