...
6. Return: a short summary of what you implemented, the list of files changed, and the final green test/lint output. If you CANNOT reach green, stop and report exactly what is blocking — never leave the gates red silently.
